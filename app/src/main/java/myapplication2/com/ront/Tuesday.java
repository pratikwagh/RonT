...
public class Tuesday extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        u=user.getUid();
        mDatabase = FirebaseDatabase.getInstance().getReference().child(u).child("Tuesday");
            ...
            protected void populateViewHolder(TaskViewHolder viewHolder, Task model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        singleTaskActivity.putExtra("Weekday","Tuesday");
                        singleTaskActivity.putExtra("value", 1);
