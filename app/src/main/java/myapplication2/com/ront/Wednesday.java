...
public class Wednesday extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        u=user.getUid();
        mDatabase = FirebaseDatabase.getInstance().getReference().child(u).child("Wednesday");
            ...
            protected void populateViewHolder(TaskViewHolder viewHolder, Task model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        singleTaskActivity.putExtra("Weekday","Wednesday");
                        singleTaskActivity.putExtra("value", 2);
