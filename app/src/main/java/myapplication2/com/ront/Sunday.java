...
public class Sunday extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        u=user.getUid();
        mDatabase = FirebaseDatabase.getInstance().getReference().child(u).child("Sunday");
            ...
            protected void populateViewHolder(TaskViewHolder viewHolder, Task model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        singleTaskActivity.putExtra("Weekday","Sunday");
                        singleTaskActivity.putExtra("value", 6);
