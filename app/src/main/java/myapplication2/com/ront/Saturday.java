...
public class Saturday extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        u=user.getUid();
        mDatabase = FirebaseDatabase.getInstance().getReference().child(u).child("Saturday");
            ...
            protected void populateViewHolder(TaskViewHolder viewHolder, Task model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        singleTaskActivity.putExtra("Weekday","Saturday");
                        singleTaskActivity.putExtra("value", 5);
